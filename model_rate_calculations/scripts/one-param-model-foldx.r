...
# OUTPUT:
# goodness-of-fit measures in "foldx_gof.csv"
# empirical and predicted rates in "foldx_rate_profiles.csv"
...
# output file names
profiles.fname <- "foldx_rate_profiles.csv"
results.fname = "foldx_gof.csv"
