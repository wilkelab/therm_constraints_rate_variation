...
'''
Description: This is a script that creates the phylip alignments used in the evolutionary rate 
'''
...
def main():
	...
	for i in xrange(0, len(pdbs)):
		...
		alignment = "../../mapped_mafft_alignments/" + pdb + "_" + chain + "_mafft.fasta"
		print pdb, chain
