...
'''
Description: This is a script that takes the raw rosetta ddG monomer output and creates a more readable format that can be used in the analysis.  
'''
...
def main(argv = sys.argv):
	...
	for i in xrange(0, len(pdbs)):
		...
		try:
			...
			s=p.get_structure('X', "../../../foldX/repaired_pdbs/RepairPDB_" + pdb + "_" + chain + ".pdb")
			ref_struct = s[0]
