...
1. download_structures.py 
	...
	To save space the original pdbs were not included just the repaired structures actually used for the  
	calculations. However, if you run this script it will download them.
	
2. create_runfiles.py
	***This is run after you repair all of pdbs using FoldX.***
